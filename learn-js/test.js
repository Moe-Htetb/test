...
// const modifiledArray = (arr, formula) => {
//   const result = [];
//   for (el of arr) {
...
// console.log(modifiledArray(numbers));

// console.log(modifiledArray(numbers, (el) => el + 4));
// console.log(modifiledArray(numbers, (el) => el * 2));
// console.log(modifiledArray(numbers, (el) => (el % 2 ? "even" : "odd")));
...
// let result = fruits.forEach((el) => {
//   console.log(el);
// });
// console.log(result);
// const results = fruits.map((el) => {
//   console.log(el);
//   return "haha"; // return pyn tae hr twy hwat
// });
// console.log(results);
...
// console.table(result);
// const filterId = [1, 4, 6, 9, 4];
// const answer = products.filter(({ id }) => {
...
// const result = products.reduce((pv, { title }) => pv + title, "");

// console.log(result);

// const point = filterId.some((el) => el === 4);
// console.log(point);
